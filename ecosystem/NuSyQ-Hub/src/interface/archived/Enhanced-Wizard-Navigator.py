...
class OllamaLLMManager:
    ...
    def __init__(self, base_url: str | None = None) -> None:
        """Initialize OllamaLLMManager with base_url."""
        from ..utils.config_helper import get_ollama_host
...
class EnhancedWizardNavigator:
    ...
    def __init__(self, repository_root: str = ".") -> None:
        """Initialize EnhancedWizardNavigator with repository_root."""
    ...
    async def launch_chatdev_project(self, project_description: str) -> str:
        ...
        try:
            ...
            discussion = await self.party_discussion(
                f"ChatDev project: {project_description}",
                context,
            )
...
class ObsidianIntegration:
    ...
    def __init__(self, repository_root: str) -> None:
        """Initialize ObsidianIntegration with repository_root."""
        self.repository_root = Path(repository_root)
...
class VSCodeIntegration:
    ...
    def __init__(self, repository_root: str) -> None:
        """Initialize VSCodeIntegration with repository_root."""
        self.repository_root = Path(repository_root)
...
class GODOTIntegration:
    ...
    def __init__(self, repository_root: str) -> None:
        """Initialize GODOTIntegration with repository_root."""
        self.repository_root = Path(repository_root)
...
class RepositoryCompendium:
    ...
    def __init__(self, repository_root: str) -> None:
        """Initialize RepositoryCompendium with repository_root."""
        self.repository_root = Path(repository_root)
        self.analysis_cache = {}
    ...
    def _analyze_python_files(self) -> dict[str, Any]:
        ...
        for py_file in python_files:
            ...
            if any(
                ...
                analysis["unique_files"].append(rel_path)
