...
Migrated from src/generators/ to canonical location (Sprint 3 Technical Debt).
...
# Import template_definitions directly (not via __init__ to avoid circular import)
# The template_definitions module remains in src/generators/ as the shared source
