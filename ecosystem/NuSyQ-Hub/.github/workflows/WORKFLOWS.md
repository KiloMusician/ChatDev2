# 🛠️ NuSyQ-Hub Workflows & Age- **Testing:** Use `python src/scripts/enhanced_agent_launcher.py test <files>` for integration tests.
- **Review/Enhance:** Use `review` and `enhance` actions for collaborative code improvement.  
- **System Health:** Run `python src/scripts/enhanced_agent_launcher.py health` before major changes.Guidance
...
- **Testing:** Use `python enhanced_agent_launcher.py test <files>` for integration tests.
- **Review/Enhance:** Use `review` and `enhance` actions for collaborative code improvement.
- **System Health:** Run `python enhanced_agent_launcher.py health` before major changes.
