...
- Relocated misplaced files to appropriate directories:
  - `ai_intermediary_checkin.py` → `src/scripts/`
  - `empirical_llm_test.py` → `src/scripts/`
  - `quest_analyzer.py` → `src/scripts/`
- Updated repository structure to reflect changes.
