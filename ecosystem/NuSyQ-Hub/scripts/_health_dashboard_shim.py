"""[DEPRECATED] Health dashboard — Use src/observability/health_dashboard_consolidated.py
...
⚠️  MIGRATION: Replace imports from scripts.health_dashboard with:
...
# Deprecation warning
warnings.warn(
    "scripts/health_dashboard.py is deprecated. "
...
if __name__ == "__main__":
    ...
    print("scripts/health_dashboard.py will be removed on 2026-04-28")
    print("Use: python -m src.observability.health_dashboard_consolidated\n")

    # Run consolidated version
