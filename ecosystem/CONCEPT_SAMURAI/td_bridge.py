"""
td_bridge.py — CONCEPT_SAMURAI ← zero-setup TerminalDepths bridge.
...
This repo: REPO_ID = "concept_samurai"
"""
...
# ── Metadata ────────────────────────────────────────────────────────────────
REPO_ID   = "concept_samurai"
REPO_NAME = "CONCEPT_SAMURAI"
...
def td_heartbeat(extra: dict = None) -> dict:
    ...
    result = hub.memory_write(f"heartbeat.concept_samurai", payload)
...
if __name__ == "__main__":
    import pprint
    print(f"=== td_bridge smoke test — CONCEPT_SAMURAI (concept_samurai) ===")
