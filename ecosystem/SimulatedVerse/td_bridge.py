"""
td_bridge.py — SimulatedVerse ← zero-setup TerminalDepths bridge.
...
This repo: REPO_ID = "simulated_verse"
"""
...
def td_heartbeat(extra: dict = None) -> dict:
    ...
    result = hub.memory_write(f"heartbeat.simulated_verse", payload)
...
if __name__ == "__main__":
    import pprint
    print(f"=== td_bridge smoke test — SimulatedVerse (simulated_verse) ===")
