...
from core.statistics import prompt_cost
from core.utils import log_visualize
...
class OpenAIModel(ModelBackend):
    ...
    def run(self, *args, **kwargs) -> Dict[str, Any]:
        ...
        # Always use modern API - remove legacy fallback
        try:
            ...
            log_visualize(f"Error in OpenAI API call: {e}")
