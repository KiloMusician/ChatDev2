...
class OpenAIEmbedding:
    ...
    def get_text_embedding(self,text: str):
            ...
            try:
                ...
                print(f"Error initializing OpenAI client in embedding.py get_text_embedding: {e}")
    ...
    def get_code_embedding(self,code: str):
            ...
            try:
                ...
                print(f"Error initializing OpenAI client in embedding.py get_code_embedding: {e}")
                client = openai.OpenAI(
                    api_key=OPENAI_API_KEY or "",
                    timeout=30.0,
                    max_retries=2
