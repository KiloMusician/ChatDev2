...
from core.chat_env import ChatEnv, ChatEnvConfig
from core.statistics import get_info
from camel.web_spider import modal_trans
from core.utils import log_visualize, now
...
class ChatChain:
    ...
    def __init__(self,
        ...
        # import all used phases in PhaseConfig.json from core.phase
        ...
        self.compose_phase_module = importlib.import_module("core.composed_phase")
        self.phase_module = importlib.import_module("core.phase")
        self.phases = dict()
...
then you should return a message in a format like \"<INFO> revised_version_of_the_description\", do not return messages in other formats.""".format(
        ...
        # Handle None objects safely
        if assistant_response.msg and hasattr(assistant_response.msg, 'content') and assistant_response.msg.content:
            ...
            revised_task_prompt = task_prompt  # fallback to original prompt
        log_visualize(
