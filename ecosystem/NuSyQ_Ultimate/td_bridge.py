"""
td_bridge.py — NuSyQ_Ultimate ← zero-setup TerminalDepths bridge.
...
This repo: REPO_ID = "nusyq_ultimate"
"""
...
# ── Metadata ────────────────────────────────────────────────────────────────
REPO_ID   = "nusyq_ultimate"
REPO_NAME = "NuSyQ_Ultimate"
...
def td_heartbeat(extra: dict = None) -> dict:
    ...
    result = hub.memory_write(f"heartbeat.nusyq_ultimate", payload)
...
if __name__ == "__main__":
    import pprint
    print(f"=== td_bridge smoke test — NuSyQ_Ultimate (nusyq_ultimate) ===")
